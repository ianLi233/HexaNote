...
questions = client.collections.create(
    ...
    properties=[
        ...
        wc.Property(name="subtitle", data_type=wc.DataType.TEXT),
        ...
        wc.Property(name="description", data_type=wc.DataType.TEXT, index_null_state=True),
        ...
        wc.Property(name="ratings_count", data_type=wc.DataType.TEXT, skip_vectorization=True),
